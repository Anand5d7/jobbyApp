    ...
    return renderJobsList ? (
      ...
      <div className="jobs-no-data-container">
        ...
        <p className="no-jobs-para">
          We could not find any jobs. Try <br />
          other filters.
        </p>
      </div>
    )
        ...
        <div className="jobs-container">
          <div className="jobs-content-container">
            <FiltersGroup
              ...
              changeMinimumSalary={this.changeMinimumSalary}
            ...
            <div className="search-container">
              <div className="job-search-input-container">
                ...
                <button
                  ...
                  onClick={this.getJobs}
                >
                  <BsSearch aria-label="50" className="job-search-icon" />
                </button>
              </div>
              {this.renderAllJobs()}
            </div>
